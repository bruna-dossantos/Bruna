...
- Lives in `~/Documents/Claude/Projects/Linear Master Data/payer_project_crosswalk.csv`.

## Linear reference data (teams, insurance projects, workflow states, labels)
- Canonical copy in `~/Documents/Claude/Projects/Linear Master Data/`.
...
## Criteria library
- Consolidated criteria `.md` files live under `~/Documents/Claude/Projects/Criteria Updates/Criteria Library` (after the 2026-07-22 cleanup).
