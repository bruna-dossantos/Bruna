...
| qualification | criteria-writer | copied 2026-08-14 from `~/Documents/Claude/skills/criteria-writer` | source only |
| qualification | criteria-writer-imaging | copied 2026-08-14 from `~/Documents/Claude/skills/criteria-writer-imaging` | source only |
...
| matcher | matcher-chat / -linear / -slack / -meetings / -agendas | copied 2026-08-14 from `~/Documents/Claude/skills/Bruna Central Database` | source only |
...
## Known follow-ups
- **`criteria-reuse-finder`** (`~/Documents/Claude/skills/`) was renamed from `payer-document-matcher` and rewritten on 2026-08-14 and was being actively edited by another live session during this migration — deliberately NOT copied in yet. Bring it in once stable.
